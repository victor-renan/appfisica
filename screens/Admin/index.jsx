...
import { ScrollView, Center, FormControl, HStack, Text, VStack, Box, Button, Input, TextArea, Select, useToast, Heading } from "native-base";
...
export function AdminScreen() {
  ...
  const getUser = async () => {
    setLoggedIn(await AsyncStorage.getItem('user'));
  }
